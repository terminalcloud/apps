...
install(){
	...
	# Procedure:
	apt-get -y install python3-dev python3-pip pandoc build-essential libpng12-dev python3-setuptools \
	libzmq-dev python3-matplotlib git libncurses5-dev
	...
	pip3 install "ipython[test]"
	pip3 install "ipython[terminal]"
	pip3 install "ipython[parallel]"
