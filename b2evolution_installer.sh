#!/bin/bash
# Script to deploy B2Evolution at Terminal.com
...
install(){
  ...
  cd $INSTALL_PATH
  wget https://raw.githubusercontent.com/terminalcloud/apps/master/others/b2evolution.zip
...
show(){
  ...
  wget -q -N https://raw.githubusercontent.com/terminalcloud/apps/master/others/b2evolution_hooks.sh
  mkdir -p /CL/hooks/
  mv b2evolution_hooks.sh /CL/hooks/startup.sh
