#!/bin/bash
# Script to deploy Dokuwiki at Terminal.com
...
show(){
  ...
  wget -q -N https://raw.githubusercontent.com/terminalcloud/apps/master/others/dokuwiki_hooks.sh
  mkdir -p /CL/hooks/
  mv dokuwiki_hooks.sh /CL/hooks/startup.sh
