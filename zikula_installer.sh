...
install(){
  ...
  apache_install
  apache_default_vhost zikula.conf $INSTALL_PATH/zikula
...
show(){
  ...
  wget -q -N https://raw.githubusercontent.com/terminalcloud/apps/master/others/zikula_hooks.sh
  mkdir -p /CL/hooks/
  mv zikula_hooks.sh /CL/hooks/startup.sh
