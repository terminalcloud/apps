#!/bin/bash
# Script to deploy MyBB at Terminal.com
...
show(){
  ...
  wget -q -N https://raw.githubusercontent.com/terminalcloud/apps/master/others/mybb_hooks.sh
  mkdir -p /CL/hooks/
  mv mybb_hooks.sh /CL/hooks/startup.sh
