...
# Script to HackerSlides at Terminal.com
...
install(){
	...
	# Procedure:
	cd $INSTALL_PATH
	git clone https://github.com/jacksingleton/hacker-slides.git
	apt-get install -y python3-pip
    cd hacker-slides
    pip3 install -r /vagrant/requirements.txt
    service apache2 restart
    cp initial-slides.md /var/slides.md && sudo chmod 777 /var/slides.md
    ./infra/install-sandstorm.sh -d -e
    sleep 3
    # Test
    echo 'cd /root/hacker-slides && spk dev'| /srv/cloudlabs/scripts/run_in_term.js
}
